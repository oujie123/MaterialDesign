package com.gacrnd.gcs.materialdesign.md2.tradition.test;
...
public class NestedTraditionLayout extends FrameLayout {
    ...
    /**
     * getScrollY = 屏幕定点坐标 - view定点坐标
     * canScrollVertically  -1代表向下滑动    不能向下滑动了返回false
     *
     * @param dy
     * @return
     */
    ...
    /**
     * 外部拦截父view没有滑的了，子view也无法滑动，因为已经被拦截了
     * scrollBy  移动view   dy大于零向上移动
     *
     * @param event
     * @return
     */
